...
def hyperparameter():
    ...
    if request.method == "POST" and "hyperparameter" in request.form:
        
        #1 Linear Regression Hyperparameter Tuning
        from sklearn.model_selection import RandomizedSearchCV
        parameters = {"fit_intercept" : ["True", "False"], "normalize" : ["True", "False"], "copy_X" : ["True", "False"]}
        random_search = RandomizedSearchCV(estimator = regressor, param_distributions = parameters, n_iter = 10, cv = 5, verbose = 2)
        random_search.fit(X_train_scaled, y_train)
        random_search.best_params_
        
        #2 Ridge Regression Hyperparameter Tuning
        from sklearn.model_selection import RandomizedSearchCV
        parameters = {"alpha" : [1, 2, 3, 4, 5], "fit_intercept" : ["True", "False"], "normalize" : ["True", "False"], "copy_X" : ["True", "False"], "max_iter" : [1, 2, 3, 4, 5], "tol" : [1, 2, 3, 4, 5], "solver" : ["auto", "svd", "cholesky", "lsqr", "sparse_cg", "sag", "saga"]}
        random_search = RandomizedSearchCV(estimator = ridge_regressor, param_distributions = parameters, n_iter = 10, cv = 5, verbose = 2)
        random_search.fit(X_train_scaled, y_train)
        random_search.best_params_
        
        #3 Lasso Regression Hyperparameter Tuning
        from sklearn.model_selection import RandomizedSearchCV
        parameters = {"alpha" : [1, 2, 3, 4, 5], "fit_intercept" : ["True", "False"], "normalize" : ["True", "False"], "precompute" : ["True", "False"], "copy_X" : ["True", "False"], "max_iter" : [1, 2, 3, 4, 5], "tol" : [1, 2, 3, 4, 5], "warm_start" : ["True", "False"], "positive" : ["True", "False"], "selection" : ["cyclic", "random"]}
        random_search = RandomizedSearchCV(estimator = lasso_regressor, param_distributions = parameters, n_iter = 10, cv = 5, verbose = 2)
